...
namespace VoidWarranty.Player
{
    public class PlayerInteraction : NetworkBehaviour
    {
        ...
        // =====================================================================
        // Scan passif � Met � jour le prompt UI en continu
        // =====================================================================
        ...
        private void ScanForInteractable()
        {
            ...
            {
                // GetComponentInParent cherche sur le collider touch� PUIS remonte la hi�rarchie
                // N�cessaire car les colliders peuvent �tre sur des enfants (compound colliders)
